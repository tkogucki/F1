...
# Plotting Location
fig2, ax2 = plt.subplots(1,1)
ax2.plot(t, brakeVel, label = 'VER Brake', linestyle = ':')
ax2.plot(t, throtVel, label = 'VER Throttle')
ax2.set_title('Austria Qualifying')
ax2.set_xlabel('Time [s]')
ax2.set_ylabel('Percentage')
ax2.plot(t_ham, brakeHam, label = 'HAM Brake',linestyle = ':')
ax2.plot(t_ham, throtHAM, label = 'HAM Throttle')
ax2.legend()
plt.show()
